...
from utils.speech_commands import validate_and_filter_commands
...
def main():
    ...
    for file_path, scene_data in scenes_data:
        ...
        detected_peaks_named = {classes.REVERSE_CLASSES[class_idx]: peaks for class_idx, peaks in
                                detected_peaks.items()}

        commands = find_speech_commands(detected_peaks_named)

        scene_commands[file_path] = validate_and_filter_commands(commands)
